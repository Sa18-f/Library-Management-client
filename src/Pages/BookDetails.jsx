            ...
            <div className="modal-box">
                <form onSubmit={handleBorrowBook}>
                    <div className="md:flex-col mb-8 gap-3">
                        ...
                        <input type="hidden" name="borrowDate" value={borrowDate.toDateString()} readOnly  />
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Return Date</span>
                            </label>
                            <DatePicker className="border-2 rounded-lg py-1 pl-3 w-full" selected={startDate} onChange={(date) => setStartDate(date)} />
                        </div>
                    </div>
                    <input type="submit" value="Submit" className="btn btn-block bg-orange-500 text-xl text-white font-bold" />
                    {/* <Link to="/" className="btn px-12 mt-3 rounded-3xl text-white text-lg bg-[#1DD100]">Close</Link> */}
                </form>
