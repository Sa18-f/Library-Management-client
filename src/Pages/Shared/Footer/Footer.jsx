...
const Footer = () => {
    return (
        <footer className="footer footer-center p-12 bg-base-300 text-base-content">
            <aside>
                ...
                <p className="font-bold text-3xl">
                    BOOK CARE <br /> <span className="font-semibold text-xl">Providing reliable books since 2002</span>
                </p>
